...
from datasets.voc_dataset_OK import VOCDataset
...
parser.add_argument('--datasets',default='v', nargs='+', help='Dataset directory path')
...
parser.add_argument('--validation_epochs', default=5, type=int,
                    help='the number epochs')
parser.add_argument('--debug_steps', default=30, type=int,
                    help='Set the debug log output frequency.')
parser.add_argument('--use_cuda', default=False, type=str2bool,
                    help='Use CUDA to train model')

parser.add_argument('--checkpoint_folder', default='./model',
...
def train(loader, net, criterion, optimizer, device, debug_steps=30, epoch=-1):
    net.train(True)
    running_loss = 0.0
